            ...
            <Card className="mb-3">
                <Card.Body className="" onClick={() => sideBar(job)}>
                    <div className="d-flex justify-content-between">
                        <div>
                            <Card.Title>
                                <span className="title text-uppercase">{job.title}</span> - <span className="text-muted 
                                font-weight-light text-capitalize">the company</span>
                            </Card.Title>

                            <Card.Subtitle className="text-muted mb-2">
                            </Card.Subtitle>
                            <Badge variant="secondary" className="mr-2 text-capitalize">{job.job_type}</Badge>
                            <Badge variant="secondary" className="text-capitalize mb-2">{job.city}</Badge>
